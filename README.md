# Примеры проектирования асинхронного API для очередей сообщений
---
#### Содержание
- [Описание Async API c IBM WebMQ](#asyncapi_ibmwebqm)
---

В этом разделе хочу показать примеры описания асинхронных API для очередей сообщений, которые приходилось выполнять на разных проектах.

---
### <a name="asyncapi_ibmwebqm">Описание асинхронного API, предоставляемего через брокер сообщений IBM WebMQ</a>
Разработка описания выполнялась в Swagger.
Исходный код: [asyncapi_example.yml](https://github.com/okunev-e/asyncapi_examples/blob/main/studio/asyncapi_example.yml)
